...
You can use the FloatMD logo (`logo_float.png` in the project root) to generate these icons.
...
# Generate PNG icons
magick logo_float.png -resize 32x32 32x32.png
magick logo_float.png -resize 128x128 128x128.png
magick logo_float.png -resize 256x256 128x128@2x.png

# Generate ICO (Windows)
magick logo_float.png -define icon:auto-resize=256,128,64,48,32,16 icon.ico
```
