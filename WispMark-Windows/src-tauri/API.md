# WispMark Tauri Backend API Documentation
...
**Note:** The WispMark window should be hidden before calling this to ensure the target application is focused.
...
Otherwise, notes are stored in `%APPDATA%/WispMark/notes.json`.
